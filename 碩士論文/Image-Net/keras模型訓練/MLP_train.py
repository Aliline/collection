...
savepath = "D:/F111156114_Aliline/imgtoword/wordtovector/組合包/MLP/"
testpath = "D:/F111156114_Aliline/imgtoword/wordtovector/組合包/MLP/"
#xy訓練資料
xvector = np.load('D:/F111156114_Aliline/imgtoword/wordtovector/vector_MLP_renew/vx290_full_corp.npy',allow_pickle=True)
yvector = np.load('D:/F111156114_Aliline/imgtoword/wordtovector/vector_MLP_renew/v290y_full_corp.npy')
...
#文字向量y
testvecotr = np.load("D:/F111156114_Aliline/imgtoword/wordtovector/vectors_290_ver2.npy")
actiname = 'tanh'
# actiname = 'LeakyReLU'
# lr=0.09
lr=0.01
...
def test_model():
    for model in os.listdir(testpath) :
        ...
        flax = 1
        testvecotr = np.load("D:/F111156114_Aliline/imgtoword/wordtovector/vectors_{}_ver2.npy".format(classes,flax))
